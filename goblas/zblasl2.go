...
func Zgbmv(trans mat.MatTrans, m, n, kl, ku int, alpha complex128, a *mat.CMatrix, x *mat.CVector, incx int, beta complex128, y *mat.CVector, incy int) (err error) {
	// var noconj bool
...
// where alpha and beta are scalars, x and y are vectors and A is an
// m by n matrix.
func Zgemv(trans mat.MatTrans, m, n int, alpha complex128, a *mat.CMatrix, x *mat.CVector, incx int, beta complex128, y *mat.CVector, incy int) (err error) {
	// var noconj bool
	// var one, temp, zero complex128
...
func Zhbmv(uplo mat.MatUplo, n, k int, alpha complex128, a *mat.CMatrix, x *mat.CVector, incx int, beta complex128, y *mat.CVector, incy int) (err error) {
	...
	return y.Hbmv(uplo, n, k, alpha, a, x, incx, beta, incy)
}
...
func Zhemv(uplo mat.MatUplo, n int, alpha complex128, a *mat.CMatrix, x *mat.CVector, incx int, beta complex128, y *mat.CVector, incy int) (err error) {
	// var one, temp1, temp2, zero complex128
	// var i, iy, j int
	...
	return y.Hemv(uplo, n, alpha, a, x, incx, beta, incy)
}
...
func Zhpmv(uplo mat.MatUplo, n int, alpha complex128, ap, x *mat.CVector, incx int, beta complex128, y *mat.CVector, incy int) (err error) {
	...
	return y.Hpmv(uplo, n, alpha, ap, x, incx, beta, incy)
}
...
func Ztbmv(uplo mat.MatUplo, trans mat.MatTrans, diag mat.MatDiag, n, k int, a *mat.CMatrix, x *mat.CVector, incx int) (err error) {
...
func Ztbsv(uplo mat.MatUplo, trans mat.MatTrans, diag mat.MatDiag, n, k int, a *mat.CMatrix, x *mat.CVector, incx int) (err error) {
	// var noconj, nounit bool
	// var temp, zero complex128
	// var i, j, kplus1, l int
...
func Ztrmv(uplo mat.MatUplo, trans mat.MatTrans, diag mat.MatDiag, n int, a *mat.CMatrix, x *mat.CVector, incx int) (err error) {
	// var noconj, nounit bool
	// var temp, zero complex128
	// var i, j int
...
// No test for singularity or near-singularity is included in this
// routine. Such tests must be performed before calling this routine.
func Ztrsv(uplo mat.MatUplo, trans mat.MatTrans, diag mat.MatDiag, n int, a *mat.CMatrix, x *mat.CVector, incx int) (err error) {
	// var noconj, nounit bool
	// var temp, zero complex128
	// var i, j int
...
func Zgerc(m, n int, alpha complex128, x *mat.CVector, incx int, y *mat.CVector, incy int, a *mat.CMatrix) (err error) {
	// var temp, zero complex128
	// var i, j int
	...
	return a.Gerc(m, n, alpha, x, incx, y, incy)
}
...
// where alpha is a scalar, x is an m element vector, y is an n element
// vector and A is an m by n matrix.
func Zgeru(m, n int, alpha complex128, x *mat.CVector, incx int, y *mat.CVector, incy int, a *mat.CMatrix) (err error) {
	// var temp, zero complex128
	// var i, j int
	...
	return a.Geru(m, n, alpha, x, incx, y, incy)
}
...
func Zher(uplo mat.MatUplo, n int, alpha float64, x *mat.CVector, incx int, a *mat.CMatrix) (err error) {
	// var temp, zero complex128
	// var i, j int
	...
	return a.Her(uplo, n, alpha, x, incx)
}
...
func Zhpr(uplo mat.MatUplo, n int, alpha float64, x *mat.CVector, incx int, ap *mat.CVector) (err error) {
	...
	return ap.Hpr(uplo, n, alpha, x, incx)
}
...
func Zher2(uplo mat.MatUplo, n int, alpha complex128, x *mat.CVector, incx int, y *mat.CVector, incy int, a *mat.CMatrix) (err error) {
	...
	return a.Her2(uplo, n, alpha, x, incx, y, incy)
}
...
func Zhpr2(uplo mat.MatUplo, n int, alpha complex128, x *mat.CVector, incx int, y *mat.CVector, incy int, ap *mat.CVector) (err error) {
	...
	return ap.Hpr2(uplo, n, alpha, x, incx, y, incy)
}
