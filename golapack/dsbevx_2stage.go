...
func Dsbevx2stage(jobz, _range byte, uplo mat.MatUplo, n, kd int, ab, q *mat.Matrix, vl, vu float64, il, iu int, abstol float64, w *mat.Vector, z *mat.Matrix, work *mat.Vector, lwork int, iwork, ifail *[]int) (m, info int, err error) {
	...
	var i, ib, imax, indd, inde, indee, indhous, indibl, indisp, indiwo, indwrk, iscale, itmp1, j, jj, lhtrd, llwork, lwmin, lwtrd int
	...
	if err != nil {
		gltest.Xerbla2("Dsbevx2stage", err)
		return
	} else if lquery {
		return
	}
	...
	if err = DsytrdSb2st('N', jobz, uplo, n, kd, ab, work.Off(indd-1), work.Off(inde-1), work.Off(indhous-1), lhtrd, work.Off(indwrk-1), llwork); err != nil {
		panic(err)
	}
