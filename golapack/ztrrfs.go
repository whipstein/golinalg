...
func Ztrrfs(uplo, trans, diag byte, n, nrhs *int, a *mat.CMatrix, lda *int, b *mat.CMatrix, ldb *int, x *mat.CMatrix, ldx *int, ferr, berr *mat.Vector, work *mat.CVector, rwork *mat.Vector, info *int) {
	...
	if (*info) != 0 {
		gltest.Xerbla([]byte("ZTRRFS"), -(*info))
		return
	}
