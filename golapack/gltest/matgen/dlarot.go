...
func Dlarot(lrows, lleft, lright bool, nl int, c, s float64, a *mat.Vector, lda int, xleft, xright float64) (float64, float64) {
	...
	//     Check for errors
	if nl < nt {
		gltest.Xerbla("Dlarot", 4)
		return xleft, xright
	}
	if lda <= 0 || (!(lrows) && lda < nl-nt) {
		gltest.Xerbla("Dlarot", 8)
		return xleft, xright
	}
