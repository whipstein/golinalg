...
func Zlatm3(m, n, i, j, isub, jsub, kl, ku, idist int, iseed *[]int, d *mat.CVector, igrade int, dl, dr *mat.CVector, ipvtng int, iwork *[]int, sparse float64) (isubRet int, jsubRet int, zlatm3Return complex128) {
