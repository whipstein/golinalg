...
// of U.
func zhet01(uplo mat.MatUplo, n int, a, afac *mat.CMatrix, ipiv *[]int, c *mat.CMatrix, rwork *mat.Vector) (resid float64) {
	...
	if err = zlavhe(uplo, ConjTrans, NonUnit, n, n, afac, ipiv, c); err != nil {
		panic(err)
	}

	//     Call ZLAVHE again to multiply by U (or L ).
	if err = zlavhe(uplo, NoTrans, Unit, n, n, afac, ipiv, c); err != nil {
		panic(err)
	}
