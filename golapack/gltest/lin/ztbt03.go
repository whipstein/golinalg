...
func ztbt03(uplo mat.MatUplo, trans mat.MatTrans, diag mat.MatDiag, n, kd, nrhs int, ab *mat.CMatrix, scale float64, cnorm *mat.Vector, tscal float64, x, b *mat.CMatrix, work *mat.CVector) (resid float64) {
