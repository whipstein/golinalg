...
func Zsyt02(uplo byte, n, nrhs *int, a *mat.CMatrix, lda *int, x *mat.CMatrix, ldx *int, b *mat.CMatrix, ldb *int, rwork *mat.Vector, resid *float64) {
	var cone complex128
	...
	goblas.Zsymm(Left, mat.UploByte(uplo), n, nrhs, toPtrc128(-cone), a, lda, x, ldx, &cone, b, ldb)
