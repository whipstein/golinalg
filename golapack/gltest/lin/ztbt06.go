...
func ztbt06(rcond, rcondc float64, uplo mat.MatUplo, diag mat.MatDiag, n, kd int, ab *mat.CMatrix, rwork *mat.Vector) (rat float64) {
	...
	if rmin < zero {
		...
		anorm = golapack.Zlantb('M', uplo, diag, n, kd, ab, rwork)
		//
