...
func Ztrt06(rcond, rcondc *float64, uplo, diag byte, n *int, a *mat.CMatrix, lda *int, rwork *mat.Vector, rat *float64) {
	...
	if rmin < zero {
		...
		anorm = golapack.Zlantr('M', uplo, diag, n, n, a, lda, rwork)
