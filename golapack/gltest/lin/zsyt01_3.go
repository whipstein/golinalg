...
// Zsyt013 reconstructs a symmetric indefinite matrix A from its
// block L*D*L' or U*D*U' factorization computed by ZSYTRF_RK
// (or ZSYTRF_BK) and computes the residual
//    norm( C - A ) / ( N * norm(A) * EPS ),
// where C is the reconstructed matrix and EPS is the machine epsilon.
func Zsyt013(uplo byte, n *int, a *mat.CMatrix, lda *int, afac *mat.CMatrix, ldafac *int, e *mat.CVector, ipiv *[]int, c *mat.CMatrix, ldc *int, rwork *mat.Vector, resid *float64) {
