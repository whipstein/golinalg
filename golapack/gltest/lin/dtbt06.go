...
func Dtbt06(rcond, rcondc *float64, uplo, diag byte, n, kd *int, ab *mat.Matrix, ldab *int, work *mat.Vector, rat *float64) {
	...
	if rmin < zero {
		...
		anorm = golapack.Dlantb('M', uplo, diag, n, kd, ab, ldab, work)
