...
func derrge(path string, t *testing.T) {
	...
	*ok = true
	...
	if c2 == "ge" {
		...
		*srnamt = "Dgerfs"
		*errt = fmt.Errorf("!trans.IsValid(): trans=Unrecognized: /")
		err = golapack.Dgerfs('/', 0, 0, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgerfs", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		err = golapack.Dgerfs(NoTrans, -1, 0, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgerfs", err)
		*errt = fmt.Errorf("nrhs < 0: nrhs=-1")
		err = golapack.Dgerfs(NoTrans, 0, -1, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgerfs", err)
		*errt = fmt.Errorf("a.Rows < max(1, n): a.Rows=1, n=2")
		err = golapack.Dgerfs(NoTrans, 2, 1, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(2), ip, b.Off(0, 0).UpdateRows(2), x.Off(0, 0).UpdateRows(2), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgerfs", err)
		*errt = fmt.Errorf("af.Rows < max(1, n): af.Rows=1, n=2")
		err = golapack.Dgerfs(NoTrans, 2, 1, a.Off(0, 0).UpdateRows(2), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(2), x.Off(0, 0).UpdateRows(2), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgerfs", err)
		*errt = fmt.Errorf("b.Rows < max(1, n): b.Rows=1, n=2")
		err = golapack.Dgerfs(NoTrans, 2, 1, a.Off(0, 0).UpdateRows(2), af.Off(0, 0).UpdateRows(2), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(2), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgerfs", err)
		*errt = fmt.Errorf("x.Rows < max(1, n): x.Rows=1, n=2")
		err = golapack.Dgerfs(NoTrans, 2, 1, a.Off(0, 0).UpdateRows(2), af.Off(0, 0).UpdateRows(2), ip, b.Off(0, 0).UpdateRows(2), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgerfs", err)

		//        Dgecon
		*srnamt = "Dgecon"
		*errt = fmt.Errorf("!onenrm && norm != 'I': norm='/'")
		_, err = golapack.Dgecon('/', 0, a.Off(0, 0).UpdateRows(1), anrm, w.VectorIdx(0), &iw)
		chkxer2("Dgecon", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		_, err = golapack.Dgecon('1', -1, a.Off(0, 0).UpdateRows(1), anrm, w.VectorIdx(0), &iw)
		chkxer2("Dgecon", err)
		*errt = fmt.Errorf("a.Rows < max(1, n): a.Rows=1, n=2")
		_, err = golapack.Dgecon('1', 2, a.Off(0, 0).UpdateRows(1), anrm, w.VectorIdx(0), &iw)
		chkxer2("Dgecon", err)
		...
		*srnamt = "Dgbrfs"
		*errt = fmt.Errorf("!trans.IsValid(): trans=Unrecognized: /")
		err = golapack.Dgbrfs('/', 0, 0, 0, 0, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		err = golapack.Dgbrfs(NoTrans, -1, 0, 0, 0, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)
		*errt = fmt.Errorf("kl < 0: kl=-1")
		err = golapack.Dgbrfs(NoTrans, 1, -1, 0, 0, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)
		*errt = fmt.Errorf("ku < 0: ku=-1")
		err = golapack.Dgbrfs(NoTrans, 1, 0, -1, 0, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)
		*errt = fmt.Errorf("nrhs < 0: nrhs=-1")
		err = golapack.Dgbrfs(NoTrans, 1, 0, 0, -1, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)
		*errt = fmt.Errorf("ab.Rows < kl+ku+1: ab.Rows=2, kl=1, ku=1")
		err = golapack.Dgbrfs(NoTrans, 2, 1, 1, 1, a.Off(0, 0).UpdateRows(2), af.Off(0, 0).UpdateRows(4), ip, b.Off(0, 0).UpdateRows(2), x.Off(0, 0).UpdateRows(2), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)
		*errt = fmt.Errorf("afb.Rows < 2*kl+ku+1: afb.Rows=3, kl=1, ku=1")
		err = golapack.Dgbrfs(NoTrans, 2, 1, 1, 1, a.Off(0, 0).UpdateRows(3), af.Off(0, 0).UpdateRows(3), ip, b.Off(0, 0).UpdateRows(2), x.Off(0, 0).UpdateRows(2), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)
		*errt = fmt.Errorf("b.Rows < max(1, n): b.Rows=1, n=2")
		err = golapack.Dgbrfs(NoTrans, 2, 0, 0, 1, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(1), x.Off(0, 0).UpdateRows(2), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)
		*errt = fmt.Errorf("x.Rows < max(1, n): x.Rows=1, n=2")
		err = golapack.Dgbrfs(NoTrans, 2, 0, 0, 1, a.Off(0, 0).UpdateRows(1), af.Off(0, 0).UpdateRows(1), ip, b.Off(0, 0).UpdateRows(2), x.Off(0, 0).UpdateRows(1), r1, r2, w.VectorIdx(0), &iw)
		chkxer2("Dgbrfs", err)

		//        Dgbcon
		*srnamt = "Dgbcon"
		*errt = fmt.Errorf("!onenrm && norm != 'I': norm='/'")
		_, err = golapack.Dgbcon('/', 0, 0, 0, a.Off(0, 0).UpdateRows(1), ip, anrm, w.VectorIdx(0), &iw)
		chkxer2("Dgbcon", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		_, err = golapack.Dgbcon('1', -1, 0, 0, a.Off(0, 0).UpdateRows(1), ip, anrm, w.VectorIdx(0), &iw)
		chkxer2("Dgbcon", err)
		*errt = fmt.Errorf("kl < 0: kl=-1")
		_, err = golapack.Dgbcon('1', 1, -1, 0, a.Off(0, 0).UpdateRows(1), ip, anrm, w.VectorIdx(0), &iw)
		chkxer2("Dgbcon", err)
		*errt = fmt.Errorf("ku < 0: ku=-1")
		_, err = golapack.Dgbcon('1', 1, 0, -1, a.Off(0, 0).UpdateRows(1), ip, anrm, w.VectorIdx(0), &iw)
		chkxer2("Dgbcon", err)
		*errt = fmt.Errorf("ab.Rows < 2*kl+ku+1: ab.Rows=3, kl=1, ku=1")
		_, err = golapack.Dgbcon('1', 2, 1, 1, a.Off(0, 0).UpdateRows(3), ip, anrm, w.VectorIdx(0), &iw)
		chkxer2("Dgbcon", err)
