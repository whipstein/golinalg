...
func Zpot03(uplo byte, n *int, a *mat.CMatrix, lda *int, ainv *mat.CMatrix, ldainv *int, work *mat.CMatrix, ldwork *int, rwork *mat.Vector, rcond, resid *float64) {
	...
	ainvnm = golapack.Zlanhe('1', uplo, n, ainv, ldainv, rwork)
	...
	goblas.Zhemm(Left, mat.UploByte(uplo), n, n, toPtrc128(-cone), a, lda, ainv, ldainv, &czero, work, ldwork)
