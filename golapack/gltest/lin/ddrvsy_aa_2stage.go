					...
					*srnamt = "DLARHS"
					...
					if ifact == 2 {
						...
						*srnamt = "DSYSV_AA_2STAGE "
						...
						golapack.DsysvAa2stage(uplo, &n, nrhs, afac.Matrix(lda, opts), &lda, ainv.Matrix(lda, opts), toPtr((3*nb+1)*n), iwork, toSlice(iwork, n), x.Matrix(lda, opts), &lda, work, &lwork, &info)
