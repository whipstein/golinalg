...
func Dqrt01(m *int, n *int, a, af, q, r *mat.Matrix, lda *int, tau, work *mat.Vector, lwork *int, rwork, result *mat.Vector) {
	...
	*srnamt = "DGEQRF"
	golapack.Dgeqrf(m, n, af, lda, tau, work, lwork, &info)
