...
func dtbt02(uplo mat.MatUplo, trans mat.MatTrans, diag mat.MatDiag, n, kd, nrhs int, ab, x, b *mat.Matrix, work *mat.Vector) (resid float64) {
	...
	if trans == NoTrans {
		anorm = golapack.Dlantb('1', uplo, diag, n, kd, ab, work)
	} else {
		anorm = golapack.Dlantb('I', uplo, diag, n, kd, ab, work)
	}
	...
	for j = 1; j <= nrhs; j++ {
		...
		if err = goblas.Dtbmv(uplo, trans, diag, n, kd, ab, work.Off(0, 1)); err != nil {
			panic(err)
		}
