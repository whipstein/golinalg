...
func dtrt06(rcond, rcondc float64, uplo mat.MatUplo, diag mat.MatDiag, n int, a *mat.Matrix, work *mat.Vector) (rat float64) {
	...
	if rmin < zero {
		...
		anorm = golapack.Dlantr('M', uplo, diag, n, n, a, work)
