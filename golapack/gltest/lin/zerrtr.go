...
func zerrtr(path string, t *testing.T) {
	...
	if c2 == "tr" {
		...
		*srnamt = "Ztptri"
		*errt = fmt.Errorf("!upper && uplo != Lower: uplo=Unrecognized: /")
		_, err = golapack.Ztptri('/', NonUnit, 0, a.CVector())
		chkxer2("Ztptri", err)
		*errt = fmt.Errorf("!nounit && diag != Unit: diag=Unrecognized: /")
		_, err = golapack.Ztptri(Upper, '/', 0, a.CVector())
		chkxer2("Ztptri", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		_, err = golapack.Ztptri(Upper, NonUnit, -1, a.CVector())
		chkxer2("Ztptri", err)

		//        Ztptrs
		*srnamt = "Ztptrs"
		*errt = fmt.Errorf("!upper && uplo != Lower: uplo=Unrecognized: /")
		_, err = golapack.Ztptrs('/', NoTrans, NonUnit, 0, 0, a.Off(0, 0).CVector(), x.CMatrix(1, opts))
		chkxer2("Ztptrs", err)
		*errt = fmt.Errorf("trans != NoTrans && trans != Trans && trans != ConjTrans: trans=Unrecognized: /")
		_, err = golapack.Ztptrs(Upper, '/', NonUnit, 0, 0, a.Off(0, 0).CVector(), x.CMatrix(1, opts))
		chkxer2("Ztptrs", err)
		*errt = fmt.Errorf("!nounit && diag != Unit: diag=Unrecognized: /")
		_, err = golapack.Ztptrs(Upper, NoTrans, '/', 0, 0, a.Off(0, 0).CVector(), x.CMatrix(1, opts))
		chkxer2("Ztptrs", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		_, err = golapack.Ztptrs(Upper, NoTrans, NonUnit, -1, 0, a.Off(0, 0).CVector(), x.CMatrix(1, opts))
		chkxer2("Ztptrs", err)
		*errt = fmt.Errorf("nrhs < 0: nrhs=-1")
		_, err = golapack.Ztptrs(Upper, NoTrans, NonUnit, 0, -1, a.Off(0, 0).CVector(), x.CMatrix(1, opts))
		chkxer2("Ztptrs", err)
		*errt = fmt.Errorf("b.Rows < max(1, n): b.Rows=1, n=2")
		_, err = golapack.Ztptrs(Upper, NoTrans, NonUnit, 2, 1, a.Off(0, 0).CVector(), x.CMatrix(1, opts))
		chkxer2("Ztptrs", err)

		//        Ztprfs
		*srnamt = "Ztprfs"
		*errt = fmt.Errorf("!upper && uplo != Lower: uplo=Unrecognized: /")
		err = golapack.Ztprfs('/', NoTrans, NonUnit, 0, 0, a.Off(0, 0).CVector(), b.CMatrix(1, opts), x.CMatrix(1, opts), r1, r2, w, rw)
		chkxer2("Ztprfs", err)
		*errt = fmt.Errorf("!notran && trans != Trans && trans != ConjTrans: trans=Unrecognized: /")
		err = golapack.Ztprfs(Upper, '/', NonUnit, 0, 0, a.Off(0, 0).CVector(), b.CMatrix(1, opts), x.CMatrix(1, opts), r1, r2, w, rw)
		chkxer2("Ztprfs", err)
		*errt = fmt.Errorf("!nounit && diag != Unit: diag=Unrecognized: /")
		err = golapack.Ztprfs(Upper, NoTrans, '/', 0, 0, a.Off(0, 0).CVector(), b.CMatrix(1, opts), x.CMatrix(1, opts), r1, r2, w, rw)
		chkxer2("Ztprfs", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		err = golapack.Ztprfs(Upper, NoTrans, NonUnit, -1, 0, a.Off(0, 0).CVector(), b.CMatrix(1, opts), x.CMatrix(1, opts), r1, r2, w, rw)
		chkxer2("Ztprfs", err)
		*errt = fmt.Errorf("nrhs < 0: nrhs=-1")
		err = golapack.Ztprfs(Upper, NoTrans, NonUnit, 0, -1, a.Off(0, 0).CVector(), b.CMatrix(1, opts), x.CMatrix(1, opts), r1, r2, w, rw)
		chkxer2("Ztprfs", err)
		*errt = fmt.Errorf("b.Rows < max(1, n): b.Rows=1, n=2")
		err = golapack.Ztprfs(Upper, NoTrans, NonUnit, 2, 1, a.Off(0, 0).CVector(), b.CMatrix(1, opts), x.CMatrix(2, opts), r1, r2, w, rw)
		chkxer2("Ztprfs", err)
		*errt = fmt.Errorf("x.Rows < max(1, n): x.Rows=1, n=2")
		err = golapack.Ztprfs(Upper, NoTrans, NonUnit, 2, 1, a.Off(0, 0).CVector(), b.CMatrix(2, opts), x.CMatrix(1, opts), r1, r2, w, rw)
		chkxer2("Ztprfs", err)

		//        Ztpcon
		*srnamt = "Ztpcon"
		*errt = fmt.Errorf("!onenrm && norm != 'I': norm='/'")
		_, err = golapack.Ztpcon('/', Upper, NonUnit, 0, a.Off(0, 0).CVector(), w, rw)
		chkxer2("Ztpcon", err)
		*errt = fmt.Errorf("!upper && uplo != Lower: uplo=Unrecognized: /")
		_, err = golapack.Ztpcon('1', '/', NonUnit, 0, a.Off(0, 0).CVector(), w, rw)
		chkxer2("Ztpcon", err)
		*errt = fmt.Errorf("!nounit && diag != Unit: diag=Unrecognized: /")
		_, err = golapack.Ztpcon('1', Upper, '/', 0, a.Off(0, 0).CVector(), w, rw)
		chkxer2("Ztpcon", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		_, err = golapack.Ztpcon('1', Upper, NonUnit, -1, a.Off(0, 0).CVector(), w, rw)
		chkxer2("Ztpcon", err)

		//        Zlatps
		*srnamt = "Zlatps"
		*errt = fmt.Errorf("!upper && uplo != Lower: uplo=Unrecognized: /")
		_, err = golapack.Zlatps('/', NoTrans, NonUnit, 'N', 0, a.Off(0, 0).CVector(), x, rw)
		chkxer2("Zlatps", err)
		*errt = fmt.Errorf("!notran && trans != Trans && trans != ConjTrans: trans=Unrecognized: /")
		_, err = golapack.Zlatps(Upper, '/', NonUnit, 'N', 0, a.Off(0, 0).CVector(), x, rw)
		chkxer2("Zlatps", err)
		*errt = fmt.Errorf("!nounit && diag != Unit: diag=Unrecognized: /")
		_, err = golapack.Zlatps(Upper, NoTrans, '/', 'N', 0, a.Off(0, 0).CVector(), x, rw)
		chkxer2("Zlatps", err)
		*errt = fmt.Errorf("normin != 'Y' && normin != 'N': normin='/'")
		_, err = golapack.Zlatps(Upper, NoTrans, NonUnit, '/', 0, a.Off(0, 0).CVector(), x, rw)
		chkxer2("Zlatps", err)
		*errt = fmt.Errorf("n < 0: n=-1")
		_, err = golapack.Zlatps(Upper, NoTrans, NonUnit, 'N', -1, a.Off(0, 0).CVector(), x, rw)
		chkxer2("Zlatps", err)
