...
func Zspt02(uplo byte, n, nrhs *int, a *mat.CVector, x *mat.CMatrix, ldx *int, b *mat.CMatrix, ldb *int, rwork *mat.Vector, resid *float64) {
	var cone complex128
	...
	for j = 1; j <= (*nrhs); j++ {
		golapack.Zspmv(uplo, n, toPtrc128(-cone), a, x.CVector(0, j-1), func() *int { y := 1; return &y }(), &cone, b.CVector(0, j-1), func() *int { y := 1; return &y }())
	}
