...
func zqrt01(m, n int, a, af, q, r *mat.CMatrix, tau, work *mat.CVector, lwork int, rwork, result *mat.Vector) {
	...
	*srnamt = "Zgeqrf"
	if err = golapack.Zgeqrf(m, n, af, tau, work, lwork); err != nil {
		panic(err)
	}
	...
	*srnamt = "Zungqr"
	...
	//     Compute R - Q'*A
	if err = r.Gemm(ConjTrans, NoTrans, m, n, m, complex(-one, 0), q, a, complex(one, 0)); err != nil {
		panic(err)
	}
	...
	if err = r.Herk(Upper, ConjTrans, m, m, -one, q, one); err != nil {
		panic(err)
	}
