		...
		label70:
			...
			if (*ipiv)[k-1] > 0 {
				if k > 1 {
					...
					if err = b.Off(k-1, 0).CVector().Gemv(ConjTrans, k-1, nrhs, one, b, a.Off(kc-1), 1, one, b.Rows); err != nil {
						panic(err)
					}
					golapack.Zlacgv(nrhs, b.Off(k-1, 0).CVector(), b.Rows)
				}
				...
				if k > 2 {
					...
					//                 Apply the transformations.
					golapack.Zlacgv(nrhs, b.Off(k-1, 0).CVector(), b.Rows)
					if err = b.Off(k-1, 0).CVector().Gemv(ConjTrans, k-2, nrhs, one, b, a.Off(kc-1), 1, one, b.Rows); err != nil {
						panic(err)
					}
					golapack.Zlacgv(nrhs, b.Off(k-1, 0).CVector(), b.Rows)

					golapack.Zlacgv(nrhs, b.Off(k-1-1, 0).CVector(), b.Rows)
					if err = b.Off(k-1-1, 0).CVector().Gemv(ConjTrans, k-2, nrhs, one, b, a.Off(kcnext-1), 1, one, b.Rows); err != nil {
						panic(err)
					}
					golapack.Zlacgv(nrhs, b.Off(k-1-1, 0).CVector(), b.Rows)
				}
		...
		label100:
			...
			if (*ipiv)[k-1] > 0 {
				if k < n {
					...
					//                 Apply the transformation
					golapack.Zlacgv(nrhs, b.Off(k-1, 0).CVector(), b.Rows)
					if err = b.Off(k-1, 0).CVector().Gemv(ConjTrans, n-k, nrhs, one, b.Off(k, 0), a.Off(kc), 1, one, b.Rows); err != nil {
						panic(err)
					}
					golapack.Zlacgv(nrhs, b.Off(k-1, 0).CVector(), b.Rows)
				}
				...
				if k < n-1 {
					...
					if err = b.Off(k, 0).CVector().Gemv(ConjTrans, n-k-1, nrhs, one, b.Off(k+2-1, 0), a.Off(kcnext), 1, one, b.Rows); err != nil {
						panic(err)
					}
					golapack.Zlacgv(nrhs, b.Off(k, 0).CVector(), b.Rows)

					golapack.Zlacgv(nrhs, b.Off(k-1, 0).CVector(), b.Rows)
					if err = b.Off(k-1, 0).CVector().Gemv(ConjTrans, n-k-1, nrhs, one, b.Off(k+2-1, 0), a.Off(kc+2-1), 1, one, b.Rows); err != nil {
						panic(err)
					}
					golapack.Zlacgv(nrhs, b.Off(k-1, 0).CVector(), b.Rows)
				}
