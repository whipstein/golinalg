...
func derrgg(path string, t *testing.T) (nt int) {
	...
	if c2 == "gg" {
		...
		*errt = fmt.Errorf("m < 0: m=-1")
		_, err = golapack.Dorcsd('Y', 'Y', 'Y', 'Y', NoTrans, 'N', -1, 0, 0, a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.OffIdx(0).Vector(), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), w, lw, &iw)
		chkxer2("Dorcsd", err)
		*errt = fmt.Errorf("p < 0 || p > m: p=-1, m=1")
		_, err = golapack.Dorcsd('Y', 'Y', 'Y', 'Y', NoTrans, 'N', 1, -1, 0, a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.OffIdx(0).Vector(), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), w, lw, &iw)
		chkxer2("Dorcsd", err)
		*errt = fmt.Errorf("q < 0 || q > m: q=-1, m=1")
		_, err = golapack.Dorcsd('Y', 'Y', 'Y', 'Y', NoTrans, 'N', 1, 1, -1, a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.OffIdx(0).Vector(), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), a.Off(0, 0).UpdateRows(1), w, lw, &iw)
		chkxer2("Dorcsd", err)
