...
func Zcsdts(m, p, q *int, x, xf *mat.CMatrix, ldx *int, u1 *mat.CMatrix, ldu1 *int, u2 *mat.CMatrix, ldu2 *int, v1t *mat.CMatrix, ldv1t *int, v2t *mat.CMatrix, ldv2t *int, theta *mat.Vector, iwork *[]int, work *mat.CVector, lwork *int, rwork, result *mat.Vector) {
	...
	goblas.Zherk(Upper, ConjTrans, m, m, toPtrf64(-realone), x, ldx, &realone, work.CMatrix(*ldx, opts), ldx)
	if (*m) > 0 {
	...
	goblas.Zgemm(NoTrans, ConjTrans, p, q, q, &one, xf, ldx, v1t, ldv1t, &zero, work.CMatrix(*ldx, opts), ldx)

	goblas.Zgemm(ConjTrans, NoTrans, p, q, p, &one, u1, ldu1, work.CMatrix(*ldx, opts), ldx, &zero, xf, ldx)
	...
	goblas.Zgemm(NoTrans, ConjTrans, p, toPtr((*m)-(*q)), toPtr((*m)-(*q)), &one, xf.Off(0, (*q)+1-1), ldx, v2t, ldv2t, &zero, work.CMatrix(*ldx, opts), ldx)

	goblas.Zgemm(ConjTrans, NoTrans, p, toPtr((*m)-(*q)), p, &one, u1, ldu1, work.CMatrix(*ldx, opts), ldx, &zero, xf.Off(0, (*q)+1-1), ldx)
	...
	goblas.Zgemm(NoTrans, ConjTrans, toPtr((*m)-(*p)), q, q, &one, xf.Off((*p)+1-1, 0), ldx, v1t, ldv1t, &zero, work.CMatrix(*ldx, opts), ldx)

	goblas.Zgemm(ConjTrans, NoTrans, toPtr((*m)-(*p)), q, toPtr((*m)-(*p)), &one, u2, ldu2, work.CMatrix(*ldx, opts), ldx, &zero, xf.Off((*p)+1-1, 0), ldx)
	...
	goblas.Zgemm(NoTrans, ConjTrans, toPtr((*m)-(*p)), toPtr((*m)-(*q)), toPtr((*m)-(*q)), &one, xf.Off((*p)+1-1, (*q)+1-1), ldx, v2t, ldv2t, &zero, work.CMatrix(*ldx, opts), ldx)

	goblas.Zgemm(ConjTrans, NoTrans, toPtr((*m)-(*p)), toPtr((*m)-(*q)), toPtr((*m)-(*p)), &one, u2, ldu2, work.CMatrix(*ldx, opts), ldx, &zero, xf.Off((*p)+1-1, (*q)+1-1), ldx)
	...
	goblas.Zherk(Upper, ConjTrans, p, p, toPtrf64(-realone), u1, ldu1, &realone, work.CMatrix(*ldu1, opts), ldu1)
	...
	goblas.Zherk(Upper, ConjTrans, toPtr((*m)-(*p)), toPtr((*m)-(*p)), toPtrf64(-realone), u2, ldu2, &realone, work.CMatrix(*ldu2, opts), ldu2)
	...
	goblas.Zherk(Upper, NoTrans, q, q, toPtrf64(-realone), v1t, ldv1t, &realone, work.CMatrix(*ldv1t, opts), ldv1t)
	...
	goblas.Zherk(Upper, NoTrans, toPtr((*m)-(*q)), toPtr((*m)-(*q)), toPtrf64(-realone), v2t, ldv2t, &realone, work.CMatrix(*ldv2t, opts), ldv2t)
	...
	goblas.Zherk(Upper, ConjTrans, q, m, toPtrf64(-realone), x, ldx, &realone, work.CMatrix(*ldx, opts), ldx)
	if (*m) > 0 {
	...
	goblas.Zgemm(NoTrans, ConjTrans, p, q, q, &one, x, ldx, v1t, ldv1t, &zero, work.CMatrix(*ldx, opts), ldx)

	goblas.Zgemm(ConjTrans, NoTrans, p, q, p, &one, u1, ldu1, work.CMatrix(*ldx, opts), ldx, &zero, x, ldx)
	...
	goblas.Zgemm(NoTrans, ConjTrans, toPtr((*m)-(*p)), q, q, &one, x.Off((*p)+1-1, 0), ldx, v1t, ldv1t, &zero, work.CMatrix(*ldx, opts), ldx)

	goblas.Zgemm(ConjTrans, NoTrans, toPtr((*m)-(*p)), q, toPtr((*m)-(*p)), &one, u2, ldu2, work.CMatrix(*ldx, opts), ldx, &zero, x.Off((*p)+1-1, 0), ldx)
