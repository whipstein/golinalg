...
func Zget54(n *int, a *mat.CMatrix, lda *int, b *mat.CMatrix, ldb *int, s *mat.CMatrix, lds *int, t *mat.CMatrix, ldt *int, u *mat.CMatrix, ldu *int, v *mat.CMatrix, ldv *int, work *mat.CVector, result *float64) {
	...
	err = goblas.Zgemm(NoTrans, NoTrans, *n, *n, *n, cone, u, *ldu, s, *lds, czero, work.CMatrixOff((*n)*(*n)+1-1, *n, opts), *n)

	err = goblas.Zgemm(NoTrans, ConjTrans, *n, *n, *n, -cone, work.CMatrixOff((*n)*(*n)+1-1, *n, opts), *n, v, *ldv, cone, work.CMatrix(*n, opts), *n)

	//     Compute W2 = B - U*T*V', and put in the workarray W(N*N+1:2*N*N)
	golapack.Zlacpy(' ', n, n, b, ldb, work.CMatrixOff((*n)*(*n)+1-1, *n, opts), n)
	err = goblas.Zgemm(NoTrans, NoTrans, *n, *n, *n, cone, u, *ldu, t, *ldt, czero, work.CMatrixOff(2*(*n)*(*n)+1-1, *n, opts), *n)

	err = goblas.Zgemm(NoTrans, ConjTrans, *n, *n, *n, -cone, work.CMatrixOff(2*(*n)*(*n)+1-1, *n, opts), *n, v, *ldv, cone, work.CMatrixOff((*n)*(*n)+1-1, *n, opts), *n)
