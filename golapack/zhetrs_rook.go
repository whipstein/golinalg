...
func Zhetrsrook(uplo byte, n, nrhs *int, a *mat.CMatrix, lda *int, ipiv *[]int, b *mat.CMatrix, ldb, info *int) {
	...
	label10:
		...
		if (*ipiv)[k-1] > 0 {
			...
			goblas.Zgeru(toPtr(k-1), nrhs, toPtrc128(-one), a.CVector(0, k-1), func() *int { y := 1; return &y }(), b.CVector(k-1, 0), ldb, b.Off(0, 0), ldb)
			...
			goblas.Zgeru(toPtr(k-2), nrhs, toPtrc128(-one), a.CVector(0, k-1), func() *int { y := 1; return &y }(), b.CVector(k-1, 0), ldb, b.Off(0, 0), ldb)
			goblas.Zgeru(toPtr(k-2), nrhs, toPtrc128(-one), a.CVector(0, k-1-1), func() *int { y := 1; return &y }(), b.CVector(k-1-1, 0), ldb, b.Off(0, 0), ldb)
