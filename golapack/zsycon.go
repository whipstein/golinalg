...
func Zsycon(uplo mat.MatUplo, n int, a *mat.CMatrix, ipiv *[]int, anorm float64, work *mat.CVector) (rcond float64, err error) {
	var upper bool
...
label30:
	...
	if kase != 0 {
		...
		if err = Zsytrs(uplo, n, 1, a, ipiv, work.CMatrix(n, opts)); err != nil {
			panic(err)
		}
		goto label30
	}
