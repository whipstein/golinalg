...
func Dsyrfs(uplo mat.MatUplo, n, nrhs int, a, af *mat.Matrix, ipiv *[]int, b, x *mat.Matrix, ferr, berr, work *mat.Vector, iwork *[]int) (info int, err error) {
	var upper bool
