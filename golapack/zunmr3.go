...
// if SIDE = 'R'.
func Zunmr3(side mat.MatSide, trans mat.MatTrans, m, n, k, l int, a *mat.CMatrix, tau *mat.CVector, c *mat.CMatrix, work *mat.CVector) (err error) {
