...
func DsytrsAa2stage(uplo byte, n *int, nrhs *int, a *mat.Matrix, lda *int, tb *mat.Vector, ltb *int, ipiv *[]int, ipiv2 *[]int, b *mat.Matrix, ldb *int, info *int) {
	...
	if upper {
		...
		if (*n) > nb {
			...
			err = goblas.Dtrsm(mat.Left, mat.Upper, mat.Trans, mat.Unit, (*n)-nb, *nrhs, one, a.Off(0, nb), b.Off(nb, 0))
		...
		if (*n) > nb {
			...
			err = goblas.Dtrsm(mat.Left, mat.Upper, mat.NoTrans, mat.Unit, (*n)-nb, *nrhs, one, a.Off(0, nb), b.Off(nb, 0))
		...
		if (*n) > nb {
			...
			err = goblas.Dtrsm(mat.Left, mat.Lower, mat.NoTrans, mat.Unit, (*n)-nb, *nrhs, one, a.Off(nb, 0), b.Off(nb, 0))
		...
		if (*n) > nb {
			...
			err = goblas.Dtrsm(mat.Left, mat.Lower, mat.Trans, mat.Unit, (*n)-nb, *nrhs, one, a.Off(nb, 0), b.Off(nb, 0))
