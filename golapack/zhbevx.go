...
func Zhbevx(jobz, _range byte, uplo mat.MatUplo, n, kd int, ab, q *mat.CMatrix, vl, vu float64, il, iu int, abstol float64, w *mat.Vector, z *mat.CMatrix, work *mat.CVector, rwork *mat.Vector, iwork, ifail *[]int) (m, info int, err error) {
	...
	var i, imax, indd, inde, indee, indibl, indisp, indiwk, indrwk, indwrk, iscale, itmp1, j, jj int
	...
	indrwk = inde + n
	indwrk = 1
	if err = Zhbtrd(jobz, uplo, n, kd, ab, rwork.Off(indd-1), rwork.Off(inde-1), q, work.Off(indwrk-1)); err != nil {
		panic(err)
	}
