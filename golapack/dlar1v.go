...
func Dlar1v(n, b1, bn int, lambda float64, d, l, ld, lld *mat.Vector, pivmin, gaptol float64, z *mat.Vector, wantnc bool, r int, isuppz *[]int, work *mat.Vector) (negcnt int, ztz, mingma float64, rOut int, nrminv, resid, rqcorr float64) {
