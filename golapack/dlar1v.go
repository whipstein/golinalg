...
func Dlar1v(n, b1, bn *int, lambda *float64, d, l, ld, lld *mat.Vector, pivmin, gaptol *float64, z *mat.Vector, wantnc bool, negcnt *int, ztz, mingma *float64, r *int, isuppz *[]int, nrminv, resid, rqcorr *float64, work *mat.Vector) {
