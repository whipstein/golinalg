...
//    entries.
func Dlaqr3(wantt, wantz bool, n, ktop, kbot, nw *int, h *mat.Matrix, ldh, iloz, ihiz *int, z *mat.Matrix, ldz, ns, nd *int, sr, si *mat.Vector, v *mat.Matrix, ldv, nh *int, t *mat.Matrix, ldt, nv *int, wv *mat.Matrix, ldwv *int, work *mat.Vector, lwork *int) {
	...
	if jw <= 2 {
		...
		Dlaqr4(true, true, &jw, func() *int { y := 1; return &y }(), &jw, t, ldt, sr, si, func() *int { y := 1; return &y }(), &jw, v, ldv, work, toPtr(-1), &infqr)
		lwk3 = int(work.Get(0))
	...
	if jw > nmin {
		Dlaqr4(true, true, &jw, func() *int { y := 1; return &y }(), &jw, t, ldt, sr.Off(kwtop-1), si.Off(kwtop-1), func() *int { y := 1; return &y }(), &jw, v, ldv, work, lwork, &infqr)
	} else {
