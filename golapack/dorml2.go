...
// if SIDE = 'R'.
func Dorml2(side mat.MatSide, trans mat.MatTrans, m, n, k int, a *mat.Matrix, tau *mat.Vector, c *mat.Matrix, work *mat.Vector) (err error) {
	...
	for _, i = range genIter(i1, i2, i3) {
		...
		aii = a.Get(i-1, i-1)
		a.Set(i-1, i-1, one)
		Dlarf(side, mi, ni, a.Off(i-1, i-1).Vector(), a.Rows, tau.Get(i-1), c.Off(ic-1, jc-1), work)
		a.Set(i-1, i-1, aii)
	}
