...
func Dgges(jobvsl, jobvsr, sort byte, selctg dlctesFunc, n int, a, b *mat.Matrix, alphar, alphai, beta *mat.Vector, vsl, vsr *mat.Matrix, work *mat.Vector, lwork int, bwork *[]bool) (sdim, info int, err error) {
