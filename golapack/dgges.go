...
func Dgges(jobvsl, jobvsr, sort byte, selctg dlctesFunc, n *int, a *mat.Matrix, lda *int, b *mat.Matrix, ldb, sdim *int, alphar, alphai, beta *mat.Vector, vsl *mat.Matrix, ldvsl *int, vsr *mat.Matrix, ldvsr *int, work *mat.Vector, lwork *int, bwork *[]bool, info *int) {
	...
	var i, icols, ierr, ihi, ijobvl, ijobvr, ileft, ilo, ip, iright, irows, itau, iwrk, maxwrk, minwrk int
