...
func Zlaqr4(wantt, wantz bool, n, ilo, ihi *int, h *mat.CMatrix, ldh *int, w *mat.CVector, iloz, ihiz *int, z *mat.CMatrix, ldz *int, work *mat.CVector, lwork, info *int) {
	var sorted bool
	...
	if (*n) <= ntiny {
		...
		//        .    NWR.GE.3.) ====
		nwr = Ilaenv(func() *int { y := 13; return &y }(), []byte("ZLAQR4"), jbcmpz, n, ilo, ihi, lwork)
		nwr = maxint(2, nwr)
		...
		nsr = Ilaenv(func() *int { y := 15; return &y }(), []byte("ZLAQR4"), jbcmpz, n, ilo, ihi, lwork)
		...
		Zlaqr2(wantt, wantz, n, ilo, ihi, toPtr(nwr+1), h, ldh, iloz, ihiz, z, ldz, &ls, &ld, w, h, ldh, n, h, ldh, n, h, ldh, work, toPtr(-1))

		//        ==== Optimal workspace = maxint(ZLAQR5, ZLAQR2) ====
		...
		nmin = Ilaenv(func() *int { y := 12; return &y }(), []byte("ZLAQR4"), jbcmpz, n, ilo, ihi, lwork)
		nmin = maxint(ntiny, nmin)

		//        ==== Nibble crossover point ====
		nibble = Ilaenv(func() *int { y := 14; return &y }(), []byte("ZLAQR4"), jbcmpz, n, ilo, ihi, lwork)
		nibble = maxint(0, nibble)

		//        ==== Accumulate reflections during ttswp?  Use block
		//        .    2-by-2 structure during matrix-matrix multiply? ====
		kacc22 = Ilaenv(func() *int { y := 16; return &y }(), []byte("ZLAQR4"), jbcmpz, n, ilo, ihi, lwork)
		...
		label20:
			...
			//           ==== Aggressive early deflation ====
			Zlaqr2(wantt, wantz, n, &ktop, &kbot, &nw, h, ldh, iloz, ihiz, z, ldz, &ls, &ld, w, h.Off(kv-1, 0), ldh, &nho, h.Off(kv-1, kt-1), ldh, &nve, h.Off(kwv-1, 0), ldh, work, lwork)
