...
// provided.
func Dppsvx(fact, uplo byte, n, nrhs *int, ap, afp *mat.Vector, equed *byte, s *mat.Vector, b *mat.Matrix, ldb *int, x *mat.Matrix, ldx *int, rcond *float64, ferr, berr, work *mat.Vector, iwork *[]int, info *int) {
	...
	if (*info) != 0 {
		gltest.Xerbla([]byte("DPPSVX"), -(*info))
		return
	}
