...
func Dsytrs2(uplo mat.MatUplo, n, nrhs int, a *mat.Matrix, ipiv *[]int, b *mat.Matrix, work *mat.Vector) (err error) {
	var upper bool
	...
	//     Revert A
	if err = Dsyconv(uplo, 'R', n, a, ipiv, work); err != nil {
		panic(err)
	}
