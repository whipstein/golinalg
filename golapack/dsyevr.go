...
// manner.
func Dsyevr(jobz, _range byte, uplo mat.MatUplo, n int, a *mat.Matrix, vl, vu float64, il, iu int, abstol float64, w *mat.Vector, z *mat.Matrix, isuppz *[]int, work *mat.Vector, lwork int, iwork *[]int, liwork int) (m, info int, err error) {
	...
	var i, ieeeok, imax, indd, inddd, inde, indee, indibl, indifl, indisp, indiwo, indtau, indwk, indwkn, iscale, j, jj, liwmin, llwork, llwrkn, lwkopt, lwmin, nb int
	...
	if err = Dsytrd(uplo, n, a, work.Off(indd-1), work.Off(inde-1), work.Off(indtau-1), work.Off(indwk-1), llwork); err != nil {
		panic(err)
	}
