...
func Dtplqt(m, n, l, mb int, a, b, t *mat.Matrix, work *mat.Vector) (err error) {
	...
	for i = 1; i <= m; i += mb {
		...
		if err = Dtplqt2(ib, nb, lb, a.Off(i-1, i-1), b.Off(i-1, 0), t.Off(0, i-1)); err != nil {
			panic(err)
		}

		//     Update by applying H**T to B(I+IB:M,:) from the right
		if i+ib <= m {
			Dtprfb(Right, NoTrans, 'F', 'R', m-i-ib+1, nb, ib, lb, b.Off(i-1, 0), t.Off(0, i-1), a.Off(i+ib-1, i-1), b.Off(i+ib-1, 0), work.Matrix(m-i-ib+1, opts))
		}
	}
