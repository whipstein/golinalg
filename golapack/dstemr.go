...
// zero divisors.
func Dstemr(jobz, _range byte, n *int, d, e *mat.Vector, vl, vu *float64, il, iu, m *int, w *mat.Vector, z *mat.Matrix, ldz, nzc *int, isuppz *[]int, tryrac *bool, work *mat.Vector, lwork *int, iwork *[]int, liwork, info *int) {
	...
	if (*info) != 0 {
		...
		gltest.Xerbla([]byte("DSTEMR"), -(*info))
