...
func Zheevx(jobz, _range byte, uplo mat.MatUplo, n int, a *mat.CMatrix, vl, vu float64, il, iu int, abstol float64, w *mat.Vector, z *mat.CMatrix, work *mat.CVector, lwork int, rwork *mat.Vector, iwork, ifail *[]int) (m, info int, err error) {
	...
	var i, imax, indd, inde, indee, indibl, indisp, indiwk, indrwk, indtau, indwrk, iscale, itmp1, j, jj, llwork, lwkmin, lwkopt, nb int
	...
	if err = Zhetrd(uplo, n, a, rwork.Off(indd-1), rwork.Off(inde-1), work.Off(indtau-1), work.Off(indwrk-1), llwork); err != nil {
		panic(err)
	}
