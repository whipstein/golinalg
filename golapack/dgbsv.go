...
func Dgbsv(n, kl, ku, nrhs int, ab *mat.Matrix, ipiv *[]int, b *mat.Matrix) (info int, err error) {
	...
	if err != nil {
		gltest.Xerbla2("Dgbsv", err)
		return
	}

	//     Compute the LU factorization of the band matrix A.
	if info, err = Dgbtrf(n, n, kl, ku, ab, ipiv); err != nil {
		panic(err)
	}
	if info == 0 {
		//        Solve the system A*X = B, overwriting B with X.
		if err = Dgbtrs(NoTrans, n, kl, ku, nrhs, ab, *ipiv, b); err != nil {
			panic(err)
		}
	}
