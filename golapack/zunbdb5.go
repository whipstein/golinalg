...
// way.
func Zunbdb5(m1, m2, n int, x1 *mat.CVector, incx1 int, x2 *mat.CVector, incx2 int, q1, q2 *mat.CMatrix, work *mat.CVector, lwork int) (err error) {
	...
	if err = Zunbdb6(m1, m2, n, x1, incx1, x2, incx2, q1, q2, work, lwork); err != nil {
		panic(err)
	}

	//     If the projection is nonzero, then return
	if x1.Nrm2(m1, incx1) != real(zero) || x2.Nrm2(m2, incx2) != real(zero) {
		return
	}
