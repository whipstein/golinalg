...
func Dlasd7(icompq, nl, nr, sqre int, d, z, zw, vf, vfw, vl, vlw *mat.Vector, alpha, beta float64, dsigma *mat.Vector, idx, idxp, idxq, perm, givcol *[]int, ldgcol int, givnum *mat.Matrix) (k, givptr int, c, s float64, err error) {
	...
	_idx1 := (*idx)[1:]
	Dlamrg(nl, nr, dsigma.Off(1), 1, 1, &_idx1)
