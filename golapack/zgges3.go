...
func Zgges3(jobvsl, jobvsr, sort byte, selctg func(complex128, complex128) bool, n *int, a *mat.CMatrix, lda *int, b *mat.CMatrix, ldb, sdim *int, alpha, beta *mat.CVector, vsl *mat.CMatrix, ldvsl *int, vsr *mat.CMatrix, ldvsr *int, work *mat.CVector, lwork *int, rwork *mat.Vector, bwork *[]bool, info *int) {
	...
	if (*info) != 0 {
		gltest.Xerbla([]byte("ZGGES3"), -(*info))
		return
	} else if lquery {
		return
	}
	...
	Zgghd3(jobvsl, jobvsr, n, &ilo, &ihi, a, lda, b, ldb, vsl, ldvsl, vsr, ldvsr, work.Off(iwrk-1), toPtr((*lwork)+1-iwrk), &ierr)
